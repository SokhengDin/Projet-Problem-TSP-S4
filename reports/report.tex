...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\color{gray}CORO Project}
...
%% ═════════════════════════════════════════════════════════════════════════════
\section{Integer Linear Programming Model~1: MTZ Formulation}
%% ═════════════════════════════════════════════════════════════════════════════
...
%% ═════════════════════════════════════════════════════════════════════════════
\section{Integer Linear Programming Model~2: Subtour Elimination Constraints (SEC)}
%% ═════════════════════════════════════════════════════════════════════════════
...
Method & Objective & Stops & Status & Time (s) & B\&B nodes \\
\midrule
MTZ       & \textbf{114} & 14 & OPTIMAL   & 4.49   & 1\,295 \\
SEC       & \textbf{114} & 14 & OPTIMAL   & 34.55  & 35 \\
Heuristic & 155          & 14 & Feasible  & $<$0.01 & --- \\
\bottomrule
\end{tabular}
\end{table}
...
The heuristic found a valid path of cost~155 (35.96\% above optimal) visiting
15~stops (14~unique). MTZ is $\approx 8\times$ faster despite exploring $37\times$
more B\&B nodes (1\,295 vs.~35). This counter-intuitive result is explained by the
overhead of the iterative SEC approach: the model was re-solved from scratch after
adding each batch of cuts (66~cuts total across multiple iterations), discarding the
B\&B tree each time. With lazy callbacks, the tighter LP bound of SEC would translate
directly into less total work.
...
Method & Objective & Stops & Status & Time (s) & B\&B nodes \\
\midrule
MTZ       & 948  & 49 & Time limit & 120.01 & 54\,695 \\
SEC       & ---  & ---  & Time limit & 161.64 & 13\,739 \\
...
(49~stops) but could not prove optimality after 54\,695~B\&B nodes. Using the
...
The SEC model explored only 13\,739~B\&B nodes (versus 54\,695 for MTZ), confirming
...
\multirow{3}{*}{\texttt{40\_1}}
  & MTZ       & 114 & 14 & 4.49    & Optimal, 1\,295 nodes \\
  & SEC       & 114 & 14 & 34.55   & Optimal, 35 nodes, 66 cuts \\
  & Heuristic & 155 & 14 & $<$0.01 & Feasible \\
\midrule
\multirow{3}{*}{\texttt{80\_1}}
  & MTZ       & 948 & 49 & 120.01  & Time limit, 54\,695 nodes \\
  & SEC       & --- & ---  & 161.64  & Time limit, 105 cuts \\
...
\multirow{3}{*}{\texttt{20\_1}}
  & MTZ       & \textbf{124} & 8 & Optimal   &  89.78 & 115\,901 & --- \\
  & SEC       & ---          & --- & Time lim &120.12  &      155 & 115 \\
  & Heuristic & 138          & 8 & Feasible  &   0.12 & ---      & --- \\
\midrule
\multirow{3}{*}{\texttt{20\_2}}
  & MTZ       & \textbf{104} & 8 & Optimal   &   3.29 &   1\,495 & --- \\
  & SEC       & ---          & --- & Time lim &121.51  &      129 & 121 \\
  & Heuristic & 119          & 8 & Feasible  &  $<$0.01 & ---    & --- \\
\midrule
\multirow{3}{*}{\texttt{20\_3}}
  & MTZ       & \textbf{104} & 8  & Optimal  &   1.94 &      892 & --- \\
  & SEC       & \textbf{104} & 8  & Optimal  &  50.60 &      140 & 101 \\
  & Heuristic & 117          & 8  & Feasible &  $<$0.01 & ---    & --- \\
\midrule
\multirow{3}{*}{\texttt{20\_4}}
  & MTZ       & \textbf{109} & 8 & Optimal   & 103.39 & 142\,906 & --- \\
  & SEC       & ---          & --- & Time lim &120.57  &      397 & 125 \\
  & Heuristic & 118          & 8 & Feasible  &  $<$0.01 & ---    & --- \\
\midrule
\multirow{3}{*}{\texttt{30\_1}}
  & MTZ       & \textbf{144} & 14 & Optimal  & 104.06 & 118\,915 & --- \\
  & SEC       & ---          & --- & Time lim &122.76  &    1\,666 & 138 \\
  & Heuristic & 152          & 14 & Feasible &  $<$0.01 & ---    & --- \\
\midrule
\multirow{3}{*}{\texttt{50\_1}}
  & MTZ       & \textbf{168} & 16 & Optimal  &  64.09 &  31\,175 & --- \\
  & SEC       & ---          & --- & Time lim &122.16  &      990 & 91 \\
  & Heuristic & 275$^\dagger$ & --- & Invalid &  $<$0.01 & ---    & --- \\
\midrule
\multirow{3}{*}{\texttt{70\_1}}
  & MTZ       & 469 & 22 & Time lim  & 120.01 &  34\,932 & --- \\
  & SEC       & --- & --- & Time lim & 141.53 &  11\,647 & 127 \\
...
\begin{itemize}[nosep]
  ...
  \item SEC consistently explores far fewer B\&B nodes than MTZ (e.g., 140 vs.\ 892
        on \texttt{20\_3}; 397 vs.\ 142\,906 on \texttt{20\_4}), confirming the
...
than MTZ on \texttt{instance\_40\_1} (35 vs.\ 1\,295), $360\times$ fewer on
\texttt{instance\_20\_4} (397 vs.\ 142\,906), and $3.0\times$ fewer on the 70-node
instance (11\,647 vs.\ 34\,932).
